...
<li><p><tt> stroke2 &lt;width&gt; &lt;color&gt; </tt> -- Повторить
рисование stroke, но с другой толшиной и цветом.
...
<li><p><tt> shift &lt;distance&gt; </tt> -- Сдвинуть линию в перпендикулярном
направлении на указанное расстояние. Применимо к шагам line, area, brd,
используется совместно со свойствами stroke, fill, patt. Игнорируется, если
используется положительное значение smooth.
