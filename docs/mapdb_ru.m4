...
(0xFF000000 - черный, 0xFFFF0000 - красный и т.п.)
...
mapsoft2: png, gif, tiff, jpeg. Параметр scale - масштаб картинки, dx и
dy - сдвиг картинки (в единицах размера картинки). По умолчанию картинка
выравнивается по центру. Если dx=dy=-0.5, то выравнивание будет сделано
по левому-нижнему углу. TODO: векторные форматы типа svg, pdf...
