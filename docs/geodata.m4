...
(<a href="man/ms2view.htm">man-страница со всеми
параметрами</a>)
...
(<a href="man/ms2render.htm">man-страница со всеми
параметрами</a>)

<h4>ms2geofig</h4>

Чтение/запись геоданных в fig-файл.
(<a href="man/ms2geofig.htm">man-страница со всеми
параметрами</a>)
