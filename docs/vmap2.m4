...
<p>Кроме того, в файле можно указать "естественное" разрешение
карты командой
<pre><tt>
set_dpi &lt;число&rt;
</tt></pre>

<p>Сейчас это значение влияет только на размер шрифтов при
преобразовании в формат fig. Привязка fig-файла должна соответствовать этому разрешению.
