...
main(){
  try {
    ...
    { // nomenclature map with margins
      ...
      assert(ss.str() ==
        "[0.249546675,98.9000709] [35.9980672,55.6666068,1.07431294]"
        "[126.905148,3019.74856] [35.9980506,55.9999457,1.03734427]"
        "[2476.75854,0.669798092] [36.4980747,55.6666146,0.47681528]"
        "[2582.29167,2921.97078] [36.4980582,55.9999536,0.444946105]");
    }
    ...
    { // nomenclature map with margins
      ...
      for (auto & r:map.ref) ss << r.first << " " << r.second;
      assert(ss.str() ==
        "[100.624773,249.450035] [35.9980672,55.6666068,1.07431294]"
        "[163.952574,1709.87428] [35.9980506,55.9999457,1.03734427]"
        "[1338.87927,200.334899] [36.4980747,55.6666146,0.47681528]"
        "[1391.64583,1660.98539] [36.4980582,55.9999536,0.444946105]");
    }
    ...
    { // 2x2 km map, Gauss-Kruger projection, 1:100'000, 300dpi
      ...
      for (auto & r:map.ref) ss << r.first << " " << r.second;
      assert(ss.str() ==
        "[0,0] [37.011672,55.9779249,-0.159490818]"
        "[0,236.220472] [37.0107502,55.9958768,-0.159750835]"
        "[236.220472,0] [37.0436899,55.9784373,-0.197250293]"
        "[236.220472,236.220472] [37.0427829,55.9963896,-0.197510269]");
    }
    ...
    { // L-shaped map, Gauss-Kruger projection, 1:100'000, 300dpi
      ...
      assert(ss.str() ==
        "[0,0] [37.011672,55.9779249,-0.159490818]"
        "[0,472.440945] [37.0098273,56.0138287,-0.160000009]"
        "[472.440945,0] [37.0757089,55.9789414,-0.234999586]"
        "[472.440945,472.440945] [37.0739236,56.0148465,-0.235508611]");
    }
